...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "border-gray-200 bg-white flex h-12 flex-row items-center justify-between gap-2 rounded-2xl border px-4 py-4 shadow-sm shadow-black/5",
        Platform.select({
          web: "focus-visible:border-purple-500 focus-visible:ring-purple-500/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:border-gray-300 w-fit whitespace-nowrap text-sm outline-none transition-[color,box-shadow] focus-visible:ring-[3px] disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:shrink-0",
        }),
