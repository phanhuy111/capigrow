...
const VerificationDocumentScreen: React.FC = () => {
  ...
  const showImagePicker = (side: "front" | "back") => {
    Alert.alert("Select Image", "Choose how you want to add your document photo", [
    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 16 }}>
        <View className="mt-4 mb-6">
          <Text className="text-2xl font-bold text-gray-900 mb-1">Document Verification</Text>
        ...
        <View className="mb-6">
          <Text className="text-lg font-semibold text-gray-900 mb-4">Select Document Type</Text>
        ...
        {selectedDocumentType && (
          <View className="mb-6">
            <Text className="text-lg font-semibold text-gray-900 mb-4">Upload Photos</Text>

            <View className="mb-4">
              <Text className="text-sm font-medium text-gray-900 mb-1">Front of Document</Text>
              <TouchableOpacity
            ...
            {selectedDoc?.requiresBack && (
              <View className="mb-4">
                <Text className="text-sm font-medium text-gray-900 mb-1">Back of Document</Text>
                <TouchableOpacity
                  className="border-2 border-dashed border-gray-300 rounded-md h-50 justify-center items-center"
        ...
        <View className="bg-gray-100 p-4 rounded-md mb-6">
          <Text className="text-sm font-semibold text-gray-900 mb-1">Tips for best results:</Text>
        ...
        >
          {isUploading ? (
            ...
            <Text className="text-white text-base font-semibold">Submit Documents</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
